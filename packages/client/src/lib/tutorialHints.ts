...
export const FEATURE_WHY: Record<string, string> = {
  ...
  opp_pts: "You won't take this trick, so throws your lowest card and keeps the points off it.",
  ...
  lose_len: 'Sheds from your longest suit, keeping guards in the shorter ones.',
